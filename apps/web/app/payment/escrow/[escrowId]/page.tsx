...
.ep-tl-circle.done{background:#0160B9;color:#fff;}
.ep-tl-circle.active{background:#fff;border:2.5px solid #0160B9;color:#0160B9;}
...
.ep-tl-label.done{color:#0160B9;}
.ep-tl-label.active{color:#0160B9;font-weight:800;}
.ep-tl-connector{flex:1;height:2px;background:#e2e8f0;margin-bottom:18px;}
.ep-tl-connector.done{background:#0160B9;}
...
.ep-party-you{font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.05em;color:#0160B9;background:#e8f4fd;padding:2px 7px;border-radius:999px;margin-left:6px;}
...
.ep-amount-total{font-size:22px;font-weight:800;color:#0160B9;}
...
.ep-action-note{font-size:12px;color:#64748b;line-height:1.6;margin-bottom:16px;background:#f8fafc;border-radius:10px;padding:10px 12px;border-left:3px solid #0160B9;}
...
.ep-btn-primary{background:#0160B9;color:#fff;box-shadow:0 3px 14px rgba(1,96,185,0.28);}
...
.ep-btn-outline:hover:not(:disabled){border-color:#0160B9;color:#0160B9;}
...
.ep-modal-textarea:focus{border-color:#0160B9;}
...
.ep-spin-dark{width:16px;height:16px;border-radius:50%;border:2.5px solid rgba(1,96,185,0.2);border-top-color:#0160B9;animation:ep-spin .7s linear infinite;flex-shrink:0;}
...
.ep-dropzone:hover,.ep-dropzone.over{border-color:#0160B9;background:#f0f7ff;}
...
.ep-file-progress-bar{height:100%;background:#0160B9;transition:width .2s;}
...
.ep-deliverable-icon{width:32px;height:32px;border-radius:8px;background:#0160B9;display:flex;align-items:center;justify-content:center;flex-shrink:0;}
.ep-deliverable-name{flex:1;font-size:13px;font-weight:600;color:#0D1B2A;word-break:break-all;}
.ep-deliverable-dl{font-size:12px;font-weight:700;color:#0160B9;text-decoration:none;flex-shrink:0;padding:4px 10px;background:#fff;border:1.5px solid #90CAF9;border-radius:8px;}
...
.ep-history-dot{width:8px;height:8px;border-radius:50%;background:#0160B9;flex-shrink:0;margin-top:5px;}
                      ...
                      {escrow.task.submissionFiles.map((raw, i) => {
                        ...
                        return (
                          <div key={i} className="ep-deliverable">
                            ...
                            <span style={{ fontSize: 10, fontWeight: 700, color: '#0160B9', background: '#e8f4fd', padding: '2px 7px', borderRadius: 6, flexShrink: 0 }}>{ext}</span>
              ...
              <div className="ep-file-list">
                {uploadedFiles.map((f, i) => (
                  <div key={i} className="ep-file-item">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="#0160B9"><path d="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/></svg>
