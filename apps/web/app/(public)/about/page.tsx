...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      {/* Founder */}
      <div className="rounded-2xl bg-[#0160B9] text-white p-8 shadow-md mb-6">
      ...
      <div className="text-center mt-8 space-y-3">
        ...
        <div className="flex justify-center gap-3">
          <Link
            href="/signup"
            className="rounded-full bg-[#0160B9] px-6 py-2.5 text-sm font-bold text-white hover:bg-[#0160B9] transition active:scale-95"
          >
            Join Free
          </Link>
          <Link
