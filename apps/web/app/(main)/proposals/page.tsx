...
.rp-budget{font-size:13px;font-weight:700;color:#0277CC;}
...
.rp-expand-btn{font-size:11px;font-weight:700;color:#0277CC;cursor:pointer;background:none;border:none;font-family:'Inter',sans-serif;margin-top:4px;padding:0;}
...
.rp-btn-primary{background:#0277CC;color:#fff;box-shadow:0 2px 10px rgba(1,96,185,0.25);}
.rp-btn-primary:hover:not(:disabled){background:#0160B9;}
...
.rp-btn-ghost:hover:not(:disabled){border-color:#0277CC;color:#0277CC;}
...
.rp-tab.active{background:#0277CC;color:#fff;border-color:#0277CC;box-shadow:0 2px 10px rgba(1,96,185,0.25);}
.rp-tab:hover:not(.active){border-color:#0277CC;color:#0277CC;}
