...
.rp-budget{font-size:13px;font-weight:700;color:#0160B9;}
...
.rp-expand-btn{font-size:11px;font-weight:700;color:#0160B9;cursor:pointer;background:none;border:none;font-family:'Inter',sans-serif;margin-top:4px;padding:0;}
...
.rp-btn-primary{background:#0160B9;color:#fff;box-shadow:0 2px 10px rgba(1,96,185,0.25);}
...
.rp-btn-ghost:hover:not(:disabled){border-color:#0160B9;color:#0160B9;}
...
.rp-tab.active{background:#0160B9;color:#fff;border-color:#0160B9;box-shadow:0 2px 10px rgba(1,96,185,0.25);}
.rp-tab:hover:not(.active){border-color:#0160B9;color:#0160B9;}
