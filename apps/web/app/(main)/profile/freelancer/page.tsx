    ...
    <>
      ...
      <div className="fp-root">
        ...
        <aside className="fp-sidebar-left">
          <button className="fp-sidebar-brand" onClick={() => router.push('/')}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="#0160B9"><path d="M7 2v11h3v9l7-12h-4l4-8z"/></svg>
            ...
            <div className="fp-cover" onClick={() => !coverUploading && coverRef.current?.click()}
              ...
              {!pageLoading && (
                <button className="fp-btn-cover"
                  ...
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="#0160B9"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04a1 1 0 0 0 0-1.41l-2.34-2.34a1 1 0 0 0-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>
                  Edit Cover
                </button>
              )}
            </div>
              ...
              {pageLoading
                ...
                : <>
                    <p className="fp-conn-count">
                      <svg width="13" height="13" viewBox="0 0 24 24" fill="#0160B9"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>
                    ...
                    <div className="fp-name-row">
                      ...
                      <button className="fp-edit-icon-btn" onClick={() => setEditSection('basic')} title="Edit basic info">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="#0160B9"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04a1 1 0 0 0 0-1.41l-2.34-2.34a1 1 0 0 0-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>
                      </button>
                    </div>
                      ...
                      <div className="fp-portfolio-inline-links">
                        {portfolioUrls.filter(p => p.url).map((p, i) => (
                          <a key={i} href={p.url} target="_blank" rel="noopener noreferrer"
                            ...
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="#0160B9"><path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z"/></svg>
                            <span>{p.label || p.url}</span>
                          </a>
                        ))}
                        <button className="fp-portfolio-inline-edit" onClick={() => setEditSection('portfolio')}>
                          <svg width="11" height="11" viewBox="0 0 24 24" fill="#0160B9"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>
              ...
              {hourlyRate > 0 && (
                <div className="fp-mini-card fp-mini-card-rate">
                  ...
                  <button className="fp-mini-card-edit" onClick={() => setEditSection('rates')} title="Edit rate">
                    <svg width="11" height="11" viewBox="0 0 24 24" fill="#0160B9"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04a1 1 0 0 0 0-1.41l-2.34-2.34a1 1 0 0 0-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>
                  </button>
                </div>
              )}
          ...
          {!pageLoading && (
                ...
                <div className="fp-combined-section">
                  <div className="fp-combined-sub-hdr">
                    <div className="fp-combined-sub-icon">
                      <svg width="13" height="13" viewBox="0 0 24 24" fill="#0160B9"><path d="M20 6h-2.18c.07-.44.18-.88.18-1.36C18 2.53 15.5 1 13 1c-1.35 0-2.56.48-3.5 1.26A4.98 4.98 0 0 0 6 1C3.5 1 1 2.53 1 4.64c0 .48.11.92.18 1.36H1C-.1 6 0 7 0 7v2h22V8c0-1.1-.9-2-2-2z"/></svg>
                    </div>
              ...
              <div className="fp-section-card">
                <div className="fp-combined-card-hdr">
                  ...
                  <button className="fp-combined-edit-btn" type="button" onClick={() => router.push('/post')}>
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="#0160B9"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>
                    New Post
                  </button>
                </div>
                <div className="fp-combined-section">
            ...
            <div className="fp-mobile-settings-bottom">
              <button className="fp-mobile-set-btn" onClick={() => router.push('/setting')}>
                ...
                <div className="fp-mobile-set-text">
                  <span className="fp-mobile-set-lbl">Settings</span>
                  <span className="fp-mobile-set-sub">Password, account</span>
                </div>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="#94a3b8"><path d="M10 6 8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>
              </button>
              <div className="fp-mobile-set-divider" />
              <button className="fp-mobile-set-btn fp-mobile-set-logout" onClick={handleLogout}>
                <div className="fp-mobile-set-icon fp-mobile-set-logout-icon">
                  <LogoutIcon />
                </div>
                <div className="fp-mobile-set-text">
                  <span className="fp-mobile-set-lbl">Log out</span>
                  <span className="fp-mobile-set-sub">Sign out of your account</span>
                </div>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="#94a3b8"><path d="M10 6 8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>
              </button>
            </div>
        ...
        <aside className="fp-sidebar-right">
          ...
          <div className="fp-right-hdr">
            ...
            <button className="fp-msg-btn" onClick={() => router.push('/messages')}>
              <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="#0160B9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="fp-wallet">
            <div className="fp-wallet-head">
              ...
              <button className="fp-wallet-icon" onClick={() => togglePanel('addFunds')}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="#0160B9"><path d="M21 18v1c0 1.1-.9 2-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14c1.1 0 2 .9 2 2v1h-9a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h9zm-9-2h10V8H12v8zm4-2.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"/></svg>
              </button>
            </div>
            {walletLoading
              ...
              return (
                <div className="fp-sb-accordion">
                  <button className="fp-sb-acc-hdr fp-sb-acc-request" onClick={() => setSidebarSection(open ? 'none' : 'request')}>
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="#0160B9"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-1 14H5c-.55 0-1-.45-1-1V7l7.5 6L19 7v10c0 .55-.45 1-1 1zm-6-7.27L4.5 6h15l-6.5 4.73z"/></svg>
                    <span>Requests</span>
            ...
            {showSwitchMenu && (
              <div className="fp-switch-menu">
                <button className="fp-switch-menu-item" onClick={() => { setShowSwitchMenu(false); router.push('/onboarding/company') }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="#0160B9"><path d="M12 7V3H2v18h20V7H12zm-2 12H4v-2h6v2zm0-4H4v-2h6v2zm0-4H4V9h6v2zm0-4H4V5h6v2zm10 12h-8V9h8v10zm-2-8h-4v2h4v-2zm0 4h-4v2h4v-2z"/></svg>
                  <span>Company Account</span>
                </button>
                <button className="fp-switch-menu-item" onClick={() => { setShowSwitchMenu(false); router.push('/profile/client') }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="#0160B9"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>
                  <span>Client Account</span>
                </button>
              </div>
            )}
            <button className="fp-switch" onClick={() => setShowSwitchMenu(v => !v)}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="#0160B9"><path d="M6.99 11 3 15l3.99 4v-3H14v-2H6.99v-3zM21 9l-3.99-4v3H10v2h7.01v3L21 9z"/></svg>
...
function Spin({ light = false }: { light?: boolean }) {
  return (
    <div style={{
      ...
      border:`2.5px solid ${light ? 'rgba(255,255,255,0.25)' : 'rgba(1,96,185,0.18)'}`,
      borderTopColor: light ? '#fff' : '#0160B9',
...
function NavIcon({ name, active=false, size=22 }: { name:string; active?:boolean; size?:number }) {
  const col = active ? '#0160B9' : 'currentColor'
...
.fp-brand{font-size:19px;font-weight:800;color:#0160B9;letter-spacing:-0.03em;font-family:'Inter',sans-serif;}

.fp-agent-btn{display:flex;align-items:center;gap:6px;background:linear-gradient(135deg,#0160B9,#0160B9);color:#fff;border:none;border-radius:999px;padding:8px 14px;font-size:13px;font-weight:600;cursor:pointer;font-family:'Inter',sans-serif;box-shadow:0 2px 8px rgba(1,96,185,0.3);transition:transform .15s;}
...
.fp-sidebar-brand{display:flex;align-items:center;gap:8px;padding:0 8px;margin-bottom:24px;background:none;border:none;cursor:pointer;text-decoration:none;}
...
.fp-nav-item:hover{background:#f0f9ff;color:#0160B9;}
.fp-nav-item.active{background:linear-gradient(135deg,#e8f4fd,#dbeffe);color:#0160B9;font-weight:700;box-shadow:inset 0 1px 3px rgba(1,96,185,0.1);}
.fp-nav-label{flex:1;}
...
.fp-mobile-settings-bottom{display:none;}
@media(max-width:899px){
  .fp-mobile-settings-bottom{
  ...
  .fp-mobile-set-btn:hover{background:#f8fafc;}
  .fp-mobile-set-btn:active{background:#f1f5f9;}
  .fp-mobile-set-icon{
    width:36px;height:36px;border-radius:10px;
    background:#f0f9ff;border:1px solid #bae6fd;
    display:flex;align-items:center;justify-content:center;
    flex-shrink:0;color:#0160B9;
  }
  .fp-mobile-set-logout-icon{background:#fef2f2;border-color:#fca5a5;color:#dc2626;}
  .fp-mobile-set-text{display:flex;flex-direction:column;gap:2px;flex:1;min-width:0;}
  .fp-mobile-set-lbl{font-size:14px;font-weight:700;color:#0f172a;font-family:'Inter',sans-serif;}
  .fp-mobile-set-logout .fp-mobile-set-lbl{color:#dc2626;}
  .fp-mobile-set-sub{font-size:11px;color:#94a3b8;font-family:'Inter',sans-serif;}
  .fp-mobile-set-divider{height:1px;background:#f1f5f9;margin:0 16px;}
}
...
/* ── COVER ── */
.fp-cover{position:relative;margin:0;border-radius:20px 20px 0 0;overflow:hidden;height:160px;cursor:pointer;background:#0a3d6e;}
.fp-cover-inner{width:100%;height:100%;}
.fp-cover-img{width:100%;height:100%;object-fit:cover;object-position:center;display:block;transition:transform .6s cubic-bezier(.2,.8,.2,1);}
.fp-cover:hover .fp-cover-img{transform:scale(1.04);}
.fp-cover-ph{width:100%;height:100%;position:relative;background:
...
.fp-cover-ph::before{content:'';position:absolute;inset:0;background-image:radial-gradient(circle, rgba(255,255,255,0.07) 1px, transparent 1.4px);background-size:26px 26px;pointer-events:none;}
.fp-cover-ph::after{content:'';position:absolute;right:-60px;top:-50px;width:240px;height:240px;border-radius:50%;background:radial-gradient(circle at center, rgba(255,255,255,0.10) 0%, transparent 65%);pointer-events:none;}
.fp-cover::after{content:'';position:absolute;inset:auto 0 0 0;height:60%;background:linear-gradient(to top, rgba(0,0,0,0.32) 0%, rgba(0,0,0,0.10) 45%, transparent 100%);pointer-events:none;z-index:1;}
...
.fp-cover-hint{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;gap:8px;color:rgba(255,255,255,0.92);font-size:13px;font-weight:600;letter-spacing:.01em;text-shadow:0 1px 2px rgba(0,0,0,0.15);z-index:2;padding:0 16px;text-align:center;}
.fp-cover-hint svg{flex-shrink:0;opacity:.85;}
.fp-cover-hint strong{font-weight:800;}
@media(min-width:900px){.fp-cover{height:200px;}}
.fp-btn-cover{position:absolute;bottom:12px;right:12px;z-index:10;background:rgba(255,255,255,0.92);color:#0160B9;border:none;padding:7px 14px;border-radius:999px;font-size:12px;font-weight:700;display:flex;align-items:center;gap:6px;cursor:pointer;backdrop-filter:blur(12px);box-shadow:0 2px 12px rgba(0,0,0,0.18);font-family:'Inter',sans-serif;transition:all .15s;}
...
.fp-btn-edit-profile{background:linear-gradient(135deg,#0284c7,#0160B9);color:#fff;border:none;padding:10px 18px;border-radius:999px;font-size:13px;font-weight:600;display:flex;align-items:center;gap:7px;cursor:pointer;font-family:'Inter',sans-serif;box-shadow:0 3px 12px rgba(1,96,185,0.3);transition:transform .15s,box-shadow .15s;}
.fp-btn-edit-profile:hover{box-shadow:0 5px 18px rgba(1,96,185,0.4);}
...
.fp-conn-count{font-size:12px;font-weight:700;color:#0160B9;display:flex;align-items:center;gap:4px;opacity:.85;}
...
.fp-title{font-size:14px;font-weight:500;color:#0160B9;margin-top:2px;font-family:'Inter',sans-serif;}
...
.fp-badge-level{background:#e8f4fd;color:#0160B9;}
...
@media(max-width:899px){.fp-mini-cards-row{margin:10px 12px 0;}}
...
.fp-mini-card-edit{position:absolute;top:7px;right:7px;width:22px;height:22px;border-radius:6px;border:none;background:rgba(1,96,185,0.08);cursor:pointer;display:flex;align-items:center;justify-content:center;opacity:0;transition:opacity .15s,background .15s;}
.fp-mini-card:hover .fp-mini-card-edit{opacity:1;}
.fp-mini-card-edit:hover{background:rgba(1,96,185,0.18);}
...
.fp-btn-edit-bio{width:100%;background:linear-gradient(135deg,#0284c7,#0160B9);color:#fff;border:none;padding:13px;border-radius:14px;font-size:14px;font-weight:800;cursor:pointer;font-family:'Inter',sans-serif;box-shadow:0 4px 18px rgba(1,96,185,0.32);transition:transform .15s,box-shadow .15s;margin-top:4px;}
.fp-btn-edit-bio:hover{box-shadow:0 6px 22px rgba(1,96,185,0.42);transform:translateY(-1px);}
...
@media(max-width:899px){.fp-section-card{margin:10px 12px 0;}}
.fp-section-hdr{display:flex;align-items:center;justify-content:space-between;padding:16px 18px 12px;border-bottom:1px solid #f1f5f9;border-left:3px solid #0160B9;}
...
@media(max-width:899px){.fp-edit-card{margin:10px 12px 0;}}
...
.fp-input:focus{border-color:#0160B9;background:#fff;box-shadow:0 0 0 3px rgba(1,96,185,0.1);}
...
.fp-toggle.on{background:#0160B9;}
...
.fp-btn-add-item{background:#0160B9;color:#fff;border:none;border-radius:10px;padding:10px 16px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;white-space:nowrap;transition:filter .15s;}
.fp-btn-add-item:active{filter:brightness(.88);}
.fp-suggestions{display:flex;flex-wrap:wrap;gap:6px;}
.fp-suggestion{background:#f0f9ff;color:#0160B9;border:1px solid #bae6fd;border-radius:999px;padding:5px 12px;font-size:11px;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;transition:all .15s;}
.fp-suggestion:hover{background:#0160B9;color:#fff;border-color:#0160B9;}
.fp-skills-edit-list{display:flex;flex-wrap:wrap;gap:7px;list-style:none;}
.fp-skill-edit-item{display:flex;align-items:center;gap:5px;background:#dbeeff;color:#0160B9;border-radius:999px;padding:5px 10px 5px 13px;font-size:11px;font-weight:800;}
...
.fp-btn-add-row:hover{border-color:#0160B9;color:#0160B9;}
...
.fp-portfolio-link{display:flex;align-items:center;gap:8px;color:#0160B9;text-decoration:none;font-size:13px;font-weight:600;padding:8px 12px;background:linear-gradient(135deg,#f0f9ff,#e8f4fd);border:1px solid #bae6fd;border-radius:10px;transition:background .15s;}
...
.fp-timeline-dot{width:10px;height:10px;border-radius:50%;background:#0160B9;flex-shrink:0;margin-top:4px;box-shadow:0 0 0 3px rgba(1,96,185,0.18);}
...
/* ── BUTTONS ── */
.fp-btn-primary{background:linear-gradient(135deg,#0284c7,#0160B9);color:#fff;border:none;border-radius:12px;padding:12px 16px;font-size:14px;font-weight:600;cursor:pointer;font-family:'Inter',sans-serif;width:100%;display:flex;align-items:center;justify-content:center;gap:7px;transition:filter .15s,box-shadow .15s;box-shadow:0 3px 12px rgba(1,96,185,0.28);}
.fp-btn-primary:not(:disabled):hover{box-shadow:0 5px 18px rgba(1,96,185,0.38);}
...
.fp-quick.active,.fp-quick:hover{background:#0160B9;border-color:#0160B9;color:#fff;}
...
.fp-wallet-icon{background:rgba(1,96,185,0.1);border:none;border-radius:10px;width:38px;height:38px;display:flex;align-items:center;justify-content:center;cursor:pointer;transition:background .15s;}
.fp-wallet-icon:hover{background:rgba(1,96,185,0.18);}
...
.fp-btn-add{width:100%;background:linear-gradient(135deg,#0160B9,#0160B9);color:#fff;border:none;font-weight:800;font-size:13px;padding:8px;border-radius:12px;cursor:pointer;margin-top:8px;font-family:'Inter',sans-serif;box-shadow:0 2px 8px rgba(1,96,185,0.22);transition:box-shadow .15s;}
.fp-btn-add:hover{box-shadow:0 4px 14px rgba(1,96,185,0.34);}
...
.fp-ov-av{position:relative;width:40px;height:40px;border-radius:50%;overflow:hidden;border:2.5px solid #fff;background:#BBDEFB;display:flex;align-items:center;justify-content:center;flex-shrink:0;}
.fp-ov-av img{width:100%;height:100%;object-fit:cover;}
.fp-ov-av span{font-size:13px;font-weight:700;color:#0160B9;}
...
.fp-modal-av{width:40px;height:40px;border-radius:50%;overflow:hidden;background:#BBDEFB;display:flex;align-items:center;justify-content:center;flex-shrink:0;}
.fp-modal-av img{width:100%;height:100%;object-fit:cover;}
.fp-modal-av span{font-size:13px;font-weight:700;color:#0160B9;}
.fp-modal-name{font-size:13px;font-weight:700;color:#0f172a;text-align:left;}
.fp-modal-viewall{width:100%;background:none;border:none;border-top:1px solid #f1f5f9;padding:12px 0 0;margin-top:10px;cursor:pointer;font-size:12px;font-weight:700;color:#0160B9;font-family:'Inter',sans-serif;text-align:center;display:block;}
...
.fp-portfolio-inline-link{display:flex;align-items:center;gap:5px;background:#f0f9ff;border:1px solid #bae6fd;border-radius:999px;padding:5px 11px;font-size:12px;font-weight:500;color:#0160B9;text-decoration:none;font-family:'Inter',sans-serif;transition:background .15s;max-width:160px;}
...
.fp-portfolio-inline-edit{display:flex;align-items:center;gap:4px;background:none;border:1px dashed #bae6fd;border-radius:999px;padding:5px 10px;font-size:11px;font-weight:600;color:#0160B9;cursor:pointer;font-family:'Inter',sans-serif;transition:all .15s;}
...
.fp-btn-add-portfolio:hover{border-color:#0160B9;color:#0160B9;}
...
.fp-ai-card-hdr{display:flex;align-items:center;gap:10px;padding:14px 14px 12px;background:linear-gradient(135deg,#0160B9,#0160B9);border-radius:16px 16px 0 0;flex-shrink:0;}
...
.fp-lang-inline-name{font-size:12px;font-weight:700;color:#0160B9;}
...
.fp-combined-edit-btn{display:flex;align-items:center;gap:4px;background:none;border:1px solid #e2e8f0;border-radius:8px;padding:4px 10px;font-size:11px;font-weight:700;color:#0160B9;cursor:pointer;font-family:'Inter',sans-serif;transition:all .15s;flex-shrink:0;}
...
.fp-combined-add-link{background:none;border:none;color:#0160B9;font-size:13px;font-weight:600;cursor:pointer;font-family:'Inter',sans-serif;padding:0;text-decoration:underline;}
...
.fp-add-skill-chip{display:inline-flex;align-items:center;gap:4px;background:none;border:1.5px dashed #bae6fd;border-radius:999px;padding:4px 10px;font-size:11px;font-weight:700;color:#0160B9;cursor:pointer;font-family:'Inter',sans-serif;transition:all .15s;}
...
.fp-skills-add-prompt:hover{border-color:#0160B9;color:#0160B9;}
...
/* ── My Posts card ── */
.fp-myposts-card{background:#fff;border-radius:14px;border:1px solid #bae6fd;overflow:hidden;box-shadow:0 1px 4px rgba(1,96,185,0.07);}
...
.fp-myposts-hdr{flex:1;display:flex;align-items:center;gap:8px;padding:11px 13px;background:none;border:none;cursor:pointer;font-family:'Inter',sans-serif;font-size:12px;font-weight:700;color:#0160B9;text-align:left;transition:background .15s;}
.fp-myposts-hdr:hover{background:rgba(0,0,0,0.03);}
.fp-myposts-hdr>span:first-of-type{flex:1;}
.fp-myposts-count{font-size:10px;font-weight:800;background:#0160B9;color:#fff;border-radius:999px;padding:1px 8px;flex-shrink:0;}
.fp-posts-arrows{display:flex;align-items:center;gap:3px;padding:0 10px;flex-shrink:0;}
.fp-posts-arrow{width:26px;height:26px;border-radius:50%;border:1.5px solid #bae6fd;background:#fff;display:flex;align-items:center;justify-content:center;cursor:pointer;color:#0160B9;transition:all .15s;flex-shrink:0;}
.fp-posts-arrow:hover{background:#0160B9;color:#fff;border-color:#0160B9;}
...
.fp-myposts-item:hover{background:#f0f9ff;border-color:#bae6fd;transform:translateY(-1px);box-shadow:0 3px 10px rgba(1,96,185,0.1);}
...
.fp-sb-post-item:hover{border-color:#93c5fd;box-shadow:0 3px 10px rgba(1,96,185,0.13);transform:translateY(-1px);}
...
.fp-sb-task-item.clickable:hover{border-color:#93c5fd;background:#f4f8ff;box-shadow:0 3px 10px rgba(1,96,185,0.1);transform:translateY(-1px);}
...
.fp-sb-task-link{font-size:10px;font-weight:700;color:#0160B9;letter-spacing:.01em;}
...
/* ── MY POSTS (main area) — horizontal swipe ── */
.fp-posts-list{
  display:flex;flex-direction:row;gap:12px;
  overflow-x:auto;padding-bottom:8px;
  scrollbar-width:none;
}
.fp-posts-list::-webkit-scrollbar{display:none;}
.fp-post-card{
  flex-shrink:0;width:230px;
  background:#f8fafc;border:1px solid #e2e8f0;border-radius:14px;
  padding:14px 15px;cursor:pointer;transition:all .18s;
  display:flex;flex-direction:column;gap:6px;
}
.fp-post-card:hover{background:#f0f9ff;border-color:#bae6fd;box-shadow:0 4px 14px rgba(1,96,185,0.1);transform:translateY(-2px);}
.fp-post-card-top{display:flex;align-items:center;gap:8px;margin-bottom:2px;flex-wrap:wrap;}
...
.fp-post-card-desc{font-size:13px;color:#64748b;line-height:1.6;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;}
.fp-posts-view-all{display:none;}
...
.fp-ai-spinner{width:14px;height:14px;border-radius:50%;border:2px solid #e2e8f0;border-top-color:#0160B9;animation:fp-spin .7s linear infinite;flex-shrink:0;}
...
.fp-ai-see-more{background:none;border:none;cursor:pointer;color:#0160B9;font-size:11px;font-weight:600;padding:0;font-family:'Inter',sans-serif;text-align:left;}
.fp-ai-generate-btn{width:100%;background:linear-gradient(135deg,#0160B9,#0160B9);color:#fff;border:none;border-radius:10px;padding:11px;font-size:13px;font-weight:600;cursor:pointer;font-family:'Inter',sans-serif;transition:opacity .15s;box-shadow:0 2px 8px rgba(1,96,185,0.28);}
...
.fp-ai-inline-btn{
  ...
  box-shadow:0 2px 6px rgba(1,96,185,0.28);
...
@keyframes fp-ai-highlight{
  0%{box-shadow:0 0 0 3px rgba(1,96,185,0.4);}
...
@media(max-width:899px){
  .fp-mobile-quickbar{
    ...
    margin:10px 12px 0;
    padding:14px 16px;
    box-shadow:0 1px 4px rgba(1,96,185,0.08),0 4px 14px rgba(1,96,185,0.1);
    border:1px solid rgba(1,96,185,0.14);
  }
  ...
  .fp-mobile-qbal-lbl{font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:#0369a1;font-family:'Inter',sans-serif;}
  .fp-mobile-qbal-amt{font-size:20px;font-weight:800;color:#0f172a;font-family:'Inter',sans-serif;letter-spacing:-.02em;line-height:1.1;}
  .fp-mobile-qbal-escrow{font-size:11px;font-weight:600;color:#0369a1;background:#bae6fd;border-radius:999px;padding:2px 8px;margin-top:3px;display:inline-block;}
  .fp-mobile-qbar-actions{display:flex;flex-direction:row;gap:8px;flex-shrink:0;}
  .fp-mobile-qbtn{border:none;border-radius:10px;padding:9px 14px;font-size:12px;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;transition:filter .15s;white-space:nowrap;display:flex;align-items:center;gap:5px;}
  .fp-mobile-qbtn:active{filter:brightness(.88);}
  .fp-mobile-qbtn-add{background:linear-gradient(135deg,#0160B9,#0160B9);color:#fff;box-shadow:0 2px 8px rgba(1,96,185,0.28);}
