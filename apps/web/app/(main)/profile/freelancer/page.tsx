...
/* ── ROOT ── */
.fp-root{display:grid;grid-template-areas:"header""main""mobile-nav";grid-template-rows:60px 1fr 60px;grid-template-columns:1fr;background:#EDF1F7;min-height:100dvh;font-family:'Inter',sans-serif;color:#0D1B2A;}
...
.fp-nav-item.active{background:#e8f4fd;color:#0077b5;font-weight:700;}
.fp-nav-label{flex:1;}
...
/* ── PROFILE CARD ── */
.fp-card{background:#fff;border-radius:0 0 24px 24px;overflow:visible;box-shadow:0 2px 12px rgba(0,0,0,0.06);}
@media(min-width:900px){.fp-card{border-radius:20px;box-shadow:0 2px 20px rgba(0,0,0,0.08);}}
...
.fp-btn-edit-profile{background:#0077b5;color:#fff;border:none;padding:10px 18px;border-radius:999px;font-size:13px;font-weight:600;display:flex;align-items:center;gap:7px;cursor:pointer;font-family:'Inter',sans-serif;box-shadow:0 3px 12px rgba(0,119,181,0.3);transition:transform .15s,box-shadow .15s;}
...
.fp-name{font-size:22px;font-weight:700;line-height:1.15;color:#0D1B2A;letter-spacing:-0.02em;font-family:'Inter',sans-serif;}
...
.fp-bio{font-size:14px;font-weight:400;color:#536279;line-height:1.7;font-family:'Inter',sans-serif;}
...
.fp-tag{background:#dbeeff;color:#005d8f;padding:5px 12px;border-radius:999px;font-size:10.5px;font-weight:600;letter-spacing:.03em;text-transform:uppercase;font-family:'Inter',sans-serif;}
.fp-rates-row{display:flex;flex-wrap:wrap;gap:8px;align-items:center;}
.fp-rate-chip{display:flex;flex-direction:column;gap:1px;background:#f8fafc;border:1px solid #e2e8f0;padding:6px 12px;border-radius:10px;}
.fp-rate-lbl{font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:.05em;color:#94a3b8;}
.fp-rate-val{font-size:14px;font-weight:800;color:#0D1B2A;}
...
.fp-btn-edit-bio{width:100%;background:#0077b5;color:#fff;border:none;padding:13px;border-radius:14px;font-size:14px;font-weight:800;cursor:pointer;font-family:'Inter',sans-serif;box-shadow:0 3px 14px rgba(0,119,181,0.25);transition:transform .15s;margin-top:4px;}
.fp-btn-edit-bio:active{transform:scale(.98);}

/* ── SECTION CARDS ── */
.fp-section-card{background:#fff;border-radius:16px;box-shadow:0 1px 8px rgba(0,0,0,0.06);overflow:hidden;margin-top:0;}
.fp-section-hdr{display:flex;align-items:center;justify-content:space-between;padding:16px 18px 12px;border-bottom:1px solid #f1f5f9;}
.fp-section-title{font-size:15px;font-weight:700;color:#0D1B2A;font-family:'Inter',sans-serif;}
...
/* ── EDIT CARDS ── */
.fp-edit-card{background:#fff;border-radius:16px;box-shadow:0 2px 18px rgba(0,0,0,0.09);overflow:hidden;}
...
.fp-edit-card-title{font-size:15px;font-weight:700;color:#0D1B2A;font-family:'Inter',sans-serif;}
...
.fp-input{width:100%;border:1.5px solid #e2e8f0;border-radius:10px;padding:10px 13px;font-size:14px;font-family:'Inter',sans-serif;color:#0D1B2A;outline:none;background:#f8fafc;transition:border-color .15s;}
...
.fp-toggle-label{font-size:13px;font-weight:600;color:#0D1B2A;}
...
.fp-rate-display-chip strong{font-size:16px;font-weight:800;color:#0D1B2A;}
...
.fp-lang-name{font-size:13px;font-weight:700;color:#0D1B2A;}
.fp-lang-prof-badge{font-size:9px;font-weight:800;text-transform:uppercase;letter-spacing:.05em;background:#dbeeff;color:#005d8f;padding:2px 7px;border-radius:999px;}
.fp-portfolio-display{display:flex;flex-direction:column;gap:8px;}
.fp-portfolio-link{display:flex;align-items:center;gap:8px;color:#0077b5;text-decoration:none;font-size:13px;font-weight:600;padding:8px 12px;background:#f0f9ff;border-radius:10px;transition:background .15s;}
...
.fp-timeline-dot{width:10px;height:10px;border-radius:50%;background:#0077b5;flex-shrink:0;margin-top:4px;}
.fp-timeline-body{flex:1;min-width:0;}
.fp-timeline-title{font-size:14px;font-weight:700;color:#0D1B2A;}
...
/* ── BUTTONS ── */
.fp-btn-primary{background:#0077b5;color:#fff;border:none;border-radius:10px;padding:12px 16px;font-size:14px;font-weight:600;cursor:pointer;font-family:'Inter',sans-serif;width:100%;display:flex;align-items:center;justify-content:center;gap:7px;transition:filter .15s;}
.fp-btn-primary:disabled{opacity:.6;cursor:not-allowed;}
.fp-btn-primary:not(:disabled):active{filter:brightness(.88);}
.fp-btn-sec{background:#f8fafc;color:#64748b;border:1.5px solid #e2e8f0;border-radius:10px;padding:12px 16px;font-size:14px;font-weight:500;cursor:pointer;font-family:'Inter',sans-serif;width:100%;transition:background .15s;}
.fp-btn-sec:active{background:#f1f5f9;}
.fp-btn-danger{background:transparent;color:#dc2626;border:1.5px solid #fca5a5;border-radius:10px;padding:12px 16px;font-size:14px;font-weight:600;cursor:pointer;font-family:'Inter',sans-serif;width:100%;display:flex;align-items:center;justify-content:center;gap:7px;transition:background .15s;}
...
.fp-bal-row strong{font-size:15px;font-weight:800;color:#0D1B2A;}

/* ── RIGHT SIDEBAR ── */
.fp-sidebar-right{display:none;grid-area:right-sidebar;}
@media(min-width:900px){.fp-sidebar-right{display:flex;flex-direction:column;gap:14px;padding:24px 14px 40px;background:#EDF1F7;position:sticky;top:0;height:100dvh;overflow-y:auto;overflow-x:hidden;min-width:0;width:100%;}}
...
.fp-wallet{background:#dbeeff;border-radius:16px;padding:16px;min-width:0;overflow:hidden;}
.fp-wallet-head{display:flex;justify-content:space-between;align-items:flex-start;}
.fp-wallet-lbl{font-size:10px;font-weight:700;letter-spacing:.07em;text-transform:uppercase;color:#005d8f;font-family:'Inter',sans-serif;}
...
.fp-wallet-amt{font-size:22px;font-weight:700;letter-spacing:-.02em;line-height:1;color:#0D1B2A;margin-top:8px;font-family:'Inter',sans-serif;}
.fp-btn-withdraw{width:100%;background:#4ade80;color:#14532d;font-weight:800;font-size:14px;padding:11px;border-radius:12px;border:none;cursor:pointer;margin-top:12px;font-family:'Inter',sans-serif;transition:transform .15s;}
.fp-btn-withdraw:active{transform:scale(.97);}
.fp-btn-add{width:100%;background:transparent;color:#0077b5;border:1.5px solid #0077b5;font-weight:800;font-size:13px;padding:8px;border-radius:12px;cursor:pointer;margin-top:8px;font-family:'Inter',sans-serif;transition:background .15s;}
.fp-btn-add:hover{background:#e8f4fd;}
.fp-conn-card{background:#fff;border-radius:16px;padding:16px;border:0.5px solid #e8edf2;min-width:0;overflow:hidden;}
...
.fp-conn-name{font-size:13px;font-weight:600;color:#0D1B2A;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}
...
.fp-switch{background:#fff;border-radius:16px;padding:12px 14px;border:0.5px solid #e8edf2;cursor:pointer;display:flex;align-items:center;gap:10px;font-family:'Inter',sans-serif;text-align:left;width:100%;min-width:0;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,0.05);transition:box-shadow .15s;}
.fp-switch:hover{box-shadow:0 3px 14px rgba(0,0,0,0.1);}
.fp-switch-title{font-size:13px;font-weight:700;color:#0D1B2A;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}
