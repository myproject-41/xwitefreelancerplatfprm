              ...
              <div className="pub-card">
                ...
                <div className="pub-below-cover">
                  ...
                  <div className="pub-action-row">
                    {profile?.role === 'COMPANY' && (
                      ...
                      >
                        <MaterialIcon name={isFollowing ? 'check' : 'add'} size={16} color={isFollowing ? '#0277CC' : '#fff'} />
                    ...
                    {isConnected ? (
                      <button
                        ...
                        disabled={msgLoading}
                      >
                        <MaterialIcon name="chat" size={16} color="#0277CC" />
                ...
                <div className="pub-profile-info">
                  <p className="pub-conn-count">
                    <MaterialIcon name="people" size={14} color="#0277CC" />
                  ...
                  {portfolioUrls.length > 0 && (
                    <div className="pub-portfolio-row">
                      {portfolioUrls.filter((p: any) => p.url).map((p: any) => (
                        ...
                        >
                          <MaterialIcon name="link" size={13} color="#0277CC" />
                          <span>{p.label}</span>
                        </a>
                      ))}
                    </div>
                ...
                <div className="pub-section-card">
                    ...
                    <>
                      <div className="pub-section-hdr">
                        <div className="pub-section-hdr-left">
                          <MaterialIcon name="translate" size={18} color="#0277CC" />
                            ...
                            return (
                              <div key={i} className="pub-lang-card">
                                <div className="pub-lang-card-icon">
                                  <MaterialIcon name="translate" size={16} color="#0277CC" />
                                </div>
                  ...
                  {experience.length > 0 && (
                    <>
                      ...
                      <div className="pub-section-hdr">
                        <div className="pub-section-hdr-left">
                          <MaterialIcon name="work" size={18} color="#0277CC" />
                  ...
                  {quals.length > 0 && (
                    <>
                      ...
                      <div className="pub-section-hdr">
                        <div className="pub-section-hdr-left">
                          <MaterialIcon name="school" size={18} color="#0277CC" />
              ...
              <div className="pub-section-card">
                ...
                >
                  <div className="pub-accordion-hdr-left">
                    <MaterialIcon name="article" size={18} color="#0277CC" />
              ...
              <div className="pub-right-card">
                ...
                {profile?.role === 'COMPANY' && (
                  <button
                    ...
                    style={isFollowing ? {background:'#fff',color:'#0277CC',border:'1.5px solid #bae6fd'} : {}}
                    onClick={handleFollow}
                    disabled={followLoading}
                  >
                    <MaterialIcon name={isFollowing ? 'check' : 'add'} size={15} color={isFollowing ? '#0277CC' : '#fff'} />
                    {followLoading ? '…' : isFollowing ? 'Following' : 'Follow'}
                  </button>
                )}
                {isConnected ? (
...
.pub-brand{font-size:19px;font-weight:800;color:#0277CC;letter-spacing:-0.03em;font-family:'Inter',sans-serif;}
...
.pub-nav-item:hover{background:#f0f9ff;color:#0277CC;}
...
.pub-spinner{width:36px;height:36px;border:3px solid #e2e8f0;border-top-color:#0277CC;border-radius:50%;animation:pub-spin .8s linear infinite;}
...
.pub-cover-ph{width:100%;height:100%;background:linear-gradient(135deg,#0f4c75 0%,#1b6ca8 30%,#0277CC 55%,#2196c4 80%,#4db8d9 100%);}
...
/* ── BUTTONS ── */
.pub-btn-connect{display:flex;align-items:center;gap:6px;background:linear-gradient(135deg,#0284c7,#0277CC);color:#fff;border:none;border-radius:999px;padding:10px 18px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;box-shadow:0 3px 12px rgba(1,96,185,0.3);transition:transform .15s,box-shadow .15s;}
...
.pub-btn-message{display:flex;align-items:center;gap:6px;background:#fff;color:#0277CC;border:1.5px solid #bae6fd;border-radius:999px;padding:10px 18px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;box-shadow:0 2px 8px rgba(1,96,185,0.12);transition:transform .15s,box-shadow .15s,background .15s;}
...
.pub-btn-follow{display:flex;align-items:center;gap:6px;background:linear-gradient(135deg,#0284c7,#0277CC);color:#fff;border:none;border-radius:999px;padding:10px 18px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;box-shadow:0 3px 12px rgba(1,96,185,0.3);transition:transform .15s,box-shadow .15s;}
.pub-btn-follow:hover{box-shadow:0 5px 18px rgba(1,96,185,0.4);}
.pub-btn-follow:active{transform:scale(.96);}
.pub-btn-follow.following{background:#fff;color:#0277CC;border:1.5px solid #bae6fd;box-shadow:0 2px 8px rgba(1,96,185,0.12);}
...
.pub-conn-count{font-size:12px;font-weight:700;color:#0277CC;display:flex;align-items:center;gap:4px;opacity:.85;}
...
.pub-title{font-size:14px;font-weight:500;color:#0277CC;margin-top:2px;}
...
.pub-portfolio-link{display:flex;align-items:center;gap:5px;background:#f0f9ff;border:1px solid #bae6fd;border-radius:999px;padding:5px 11px;font-size:12px;font-weight:500;color:#0277CC;text-decoration:none;transition:background .15s;}
...
.pub-section-hdr{display:flex;align-items:center;justify-content:space-between;padding:14px 18px 12px;border-bottom:1px solid #f1f5f9;border-left:3px solid #0277CC;}
...
.pub-btn-connect-inline{display:flex;align-items:center;gap:6px;background:linear-gradient(135deg,#0284c7,#0277CC);color:#fff;border:none;border-radius:999px;padding:10px 20px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;box-shadow:0 3px 12px rgba(1,96,185,0.28);margin-top:4px;transition:transform .15s;}
...
.pub-lang-card{display:flex;align-items:center;gap:10px;padding:10px 14px;background:#f8fafc;border:1px solid #e2e8f0;border-left:3px solid #0277CC;border-radius:0 10px 10px 0;}
...
.pub-exp-logo{width:40px;height:40px;border-radius:10px;background:linear-gradient(135deg,#0160B9,#0277CC);display:flex;align-items:center;justify-content:center;flex-shrink:0;color:#fff;font-size:13px;font-weight:800;letter-spacing:.02em;}
.pub-exp-body{flex:1;min-width:0;}
.pub-exp-role{font-size:14px;font-weight:700;color:#0f172a;}
.pub-exp-company{font-size:13px;font-weight:500;color:#0277CC;margin-top:1px;}
...
.pub-btn-message-full{display:flex;align-items:center;justify-content:center;gap:6px;width:100%;background:#fff;color:#0277CC;border:1.5px solid #bae6fd;border-radius:999px;padding:10px 16px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;margin-top:4px;box-shadow:0 2px 8px rgba(1,96,185,0.1);transition:transform .15s,background .15s;}
...
.pub-btn-connect-full{display:flex;align-items:center;justify-content:center;gap:6px;width:100%;background:linear-gradient(135deg,#0284c7,#0277CC);color:#fff;border:none;border-radius:999px;padding:10px 16px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;margin-top:4px;box-shadow:0 3px 10px rgba(1,96,185,0.28);transition:transform .15s;}
