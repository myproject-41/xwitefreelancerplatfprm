              ...
              <div className="cp-pub-card">
                ...
                <div className="cp-pub-info">
                  ...
                  {profile.website && (
                    ...
                    >
                      <MaterialIcon name="language" size={13} color="#0160B9" />
            ...
            <>
              ...
              {(profile.website || profile.employeeCount) && (
                <div className="cp-pub-details-card">
                  ...
                  {profile.website && (
                    <div className="cp-pub-detail-row">
                      <MaterialIcon name="language" size={15} color="#0160B9" />
                      <a
                        href={profile.website.startsWith('http') ? profile.website : `https://${profile.website}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        style={{ color: '#0160B9', textDecoration: 'none', fontWeight: 600 }}
                      >
                        {profile.website.replace(/^https?:\/\//, '')}
                      </a>
                    </div>
...
.cp-pub-brand{font-size:19px;font-weight:800;color:#0160B9;letter-spacing:-0.03em;font-family:'Inter',sans-serif;}
...
.cp-pub-nav-item:hover{background:#f0f9ff;color:#0160B9;}
...
.cp-pub-spinner{width:36px;height:36px;border:3px solid #e2e8f0;border-top-color:#0160B9;border-radius:50%;animation:cp-pub-spin .8s linear infinite;}
...
.cp-pub-below-cover{display:flex;align-items:flex-end;justify-content:space-between;padding:0 18px;margin-top:-58px;margin-bottom:10px;position:relative;z-index:20;}
@media(max-width:899px){.cp-pub-below-cover{flex-wrap:wrap;}.cp-pub-action-row{width:100%;padding-top:10px;}}
@media(min-width:900px){.cp-pub-below-cover{padding:0 24px;margin-top:-66px;}}
...
.cp-pub-btn-follow{display:flex;align-items:center;gap:6px;background:linear-gradient(135deg,#0284c7,#0160B9);color:#fff;border:none;border-radius:999px;padding:10px 18px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;box-shadow:0 3px 12px rgba(1,96,185,0.3);transition:all .15s;}
.cp-pub-btn-follow:hover{box-shadow:0 5px 18px rgba(1,96,185,0.4);}
.cp-pub-btn-follow:active{transform:scale(.96);}
.cp-pub-btn-follow.following{background:#fff;color:#0160B9;border:1.5px solid #bae6fd;box-shadow:0 2px 8px rgba(1,96,185,0.12);}
.cp-pub-btn-follow.following:hover{background:#fff;}
.cp-pub-btn-follow:disabled{opacity:.75;cursor:not-allowed;}
.cp-pub-btn-message{display:flex;align-items:center;gap:6px;background:#fff;color:#0160B9;border:1.5px solid #bae6fd;border-radius:999px;padding:10px 18px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;box-shadow:0 2px 8px rgba(1,96,185,0.12);transition:all .15s;}
...
.cp-pub-follower-count{font-size:12px;font-weight:700;color:#0160B9;}
...
.cp-pub-website{font-size:12px;font-weight:600;color:#0160B9;text-decoration:none;display:flex;align-items:center;gap:4px;}
...
.cp-pub-post-card:hover{background:#f0f9ff;border-color:#bae6fd;box-shadow:0 3px 12px rgba(1,96,185,0.1);transform:translateY(-1px);}
...
.cp-pub-post-budget{font-size:13px;font-weight:800;color:#0160B9;margin-bottom:4px;}
...
@media(min-width:900px){.cp-pub-sidebar-right{display:flex;flex-direction:column;gap:10px;padding:24px 14px;background:#f1f5f9;position:sticky;top:24px;max-height:calc(100dvh - 48px);overflow-y:auto;align-self:start;}}
...
.cp-pub-right-followers{font-size:12px;font-weight:700;color:#0160B9;}
.cp-pub-btn-follow-full{display:flex;align-items:center;justify-content:center;gap:6px;width:100%;background:linear-gradient(135deg,#0284c7,#0160B9);color:#fff;border:none;border-radius:999px;padding:10px 16px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;box-shadow:0 3px 10px rgba(1,96,185,0.28);transition:all .15s;}
.cp-pub-btn-follow-full:hover{transform:translateY(-1px);}
.cp-pub-btn-follow-full.following{background:#fff;color:#0160B9;border:1.5px solid #bae6fd;box-shadow:0 2px 8px rgba(1,96,185,0.12);}
.cp-pub-btn-follow-full.following:hover{background:#fff;}
.cp-pub-btn-follow-full:disabled{opacity:.7;cursor:not-allowed;}
.cp-pub-btn-msg-full{display:flex;align-items:center;justify-content:center;gap:6px;width:100%;background:#fff;color:#0160B9;border:1.5px solid #bae6fd;border-radius:999px;padding:10px 16px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;box-shadow:0 2px 8px rgba(1,96,185,0.12);transition:all .15s;margin-top:2px;}
