...
.mp-tab.active{background:#0277CC;color:#fff;border-color:#0277CC;box-shadow:0 2px 10px rgba(1,96,185,0.25);}
.mp-tab:hover:not(.active){border-color:#0277CC;color:#0277CC;}
...
.mp-card:hover{box-shadow:0 4px 24px rgba(1,96,185,0.11);}
...
.mp-post-title:hover{color:#0277CC;}
...
.mp-proposed{font-size:11px;font-weight:700;color:#0277CC;background:#e8f4fd;padding:3px 9px;border-radius:999px;}
...
.mp-btn-escrow{background:#0277CC;color:#fff;box-shadow:0 2px 10px rgba(1,96,185,0.25);}
.mp-btn-escrow:hover:not(:disabled){background:#0160B9;}
.mp-btn-post{background:#f0f9ff;color:#0277CC;border:1.5px solid #bae6fd;}
