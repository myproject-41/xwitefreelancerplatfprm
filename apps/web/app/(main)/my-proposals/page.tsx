...
.mp-tab.active{background:#0160B9;color:#fff;border-color:#0160B9;box-shadow:0 2px 10px rgba(1,96,185,0.25);}
.mp-tab:hover:not(.active){border-color:#0160B9;color:#0160B9;}
...
.mp-post-title:hover{color:#0160B9;}
...
.mp-proposed{font-size:11px;font-weight:700;color:#0160B9;background:#e8f4fd;padding:3px 9px;border-radius:999px;}
...
.mp-btn-escrow{background:#0160B9;color:#fff;box-shadow:0 2px 10px rgba(1,96,185,0.25);}
.mp-btn-escrow:hover:not(:disabled){background:#0160B9;}
.mp-btn-post{background:#f0f9ff;color:#0160B9;border:1.5px solid #bae6fd;}
