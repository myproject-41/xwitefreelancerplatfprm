...
.pp-section-hdr{display:flex;align-items:center;justify-content:space-between;padding:15px 20px 12px;border-bottom:1px solid #f1f5f9;border-left:3px solid #0160B9;}
...
.pp-btn-connect{display:flex;align-items:center;gap:7px;background:linear-gradient(135deg,#0284c7,#0160B9);color:#fff;border:none;padding:11px 22px;border-radius:999px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;box-shadow:0 3px 14px rgba(1,96,185,0.38);transition:transform .15s,box-shadow .15s;}
...
.pp-btn-follow{display:flex;align-items:center;gap:7px;background:transparent;color:#0160B9;border:1.5px solid #0160B9;padding:10px 20px;border-radius:999px;font-size:13px;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;transition:all .15s;}
...
.pp-conn-count{font-size:12px;font-weight:700;color:#0160B9;display:flex;align-items:center;gap:4px;}
.pp-followers-btn{display:inline-flex;align-items:center;gap:4px;font-size:12px;font-weight:700;color:#0160B9;cursor:pointer;background:none;border:none;padding:0;font-family:'Inter',sans-serif;}
...
.pp-subtitle{font-size:14px;font-weight:600;color:#0160B9;margin-top:2px;}
...
.pp-portfolio-link{display:flex;align-items:center;gap:8px;color:#0160B9;text-decoration:none;font-size:13px;font-weight:600;padding:9px 14px;background:linear-gradient(135deg,#f0f9ff,#e8f4fd);border-radius:12px;border:1px solid #bae6fd;transition:all .15s;}
...
.pp-industry{font-size:14px;font-weight:600;color:#0160B9;margin-top:3px;display:flex;align-items:center;gap:5px;}
...
.pp-badge-web{background:#f8fafc;color:#0160B9;border:1px solid #e2e8f0;text-decoration:none;}
...
.pp-detail-link{font-size:14px;font-weight:500;color:#0160B9;text-align:right;text-decoration:none;}
...
.pp-tl-dot{width:10px;height:10px;border-radius:50%;background:#0160B9;flex-shrink:0;margin-top:5px;box-shadow:0 0 0 3px rgba(1,96,185,0.15);}
...
.pp-spin-blue{width:15px;height:15px;border-radius:50%;border:2.5px solid rgba(1,96,185,0.2);border-top-color:#0160B9;animation:pp-spin .7s linear infinite;display:inline-block;flex-shrink:0;}
        ...
        <div className="pp-info">
          <div className="pp-conn-row">
            ...
            <button className="pp-followers-btn" onClick={onOpenFollowers}>
              <svg width="12" height="12" viewBox="0 0 24 24" fill="#0160B9"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>
